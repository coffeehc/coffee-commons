...
/**
 * This listener registers an {@link InjectionListener} for each type for which
 * it is notified. When its {@link InjectionListener#afterInjection(Object)} is
 * invoked, a listener registers all annotated fields on the given injectee.
 *
