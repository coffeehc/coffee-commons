...
public final class StatExposers {
	...
	/**
	 * This exposure performs some basic inferences on a value to determine how
	 * it should expose the value as an equivalent. As a default case, it
	 * returns the string value of the stat.
	 */
	public final static class InferenceExposer implements StatExposer<Object> {
		@SuppressWarnings("unchecked")
		@Override
		public Object expose(Object target) {
