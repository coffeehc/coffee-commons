...
import com.coffee.common.base.exceptioin.PackageScanFailedException;
...
public class Classes {
	...
	/**
	 * @param pack
	 *            A list of packages to scan, recursively.
	 * @return A set of all the classes inside this package
	 * @throws PackageScanFailedException
	 *             Thrown when error reading from disk or jar.
	 * @throws IllegalStateException
	 *             Thrown when something very odd is
